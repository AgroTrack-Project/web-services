...
import org.example.agrotrack.shared.interfaces.resources.ErrorResource;
...
public class ErrorResponseAssembler {
    ...
    public static ResponseEntity<ErrorResource> toErrorResponseFromApplicationError(ApplicationError error) {
        ...
        String localizedMessage = toLocalizeMessageFromApplicationError(error);
    ...
    private static String toLocalizeMessageFromApplicationError(ApplicationError error) {
        ...
        if (error.details() != null) {
            String detailsAsMessage = toLocalizedMessageOrNull(error.details());
            if (detailsAsMessage != null) {
                return detailsAsMessage;
            }
        }
